...
public class MedicineJAXBParserTest {
    private final Parser jaxbParser = new MedicineJAXBParser(XSD_PATH);
    ...
    public void testParseShouldReturnListOfMedicinesWhenCorrectPathProvided() throws ParserException {
        ...
        // when
        List<Medicine> result = jaxbParser.parse(CORRECT_XML_PATH);
        // then
